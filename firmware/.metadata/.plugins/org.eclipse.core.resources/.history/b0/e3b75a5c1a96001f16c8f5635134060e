...
#ifndef IMU_INTERFACES__SRV__DETAIL__IMU_CALIBRATION__FUNCTIONS_H_
#define IMU_INTERFACES__SRV__DETAIL__IMU_CALIBRATION__FUNCTIONS_H_
...
/// Initialize srv/ImuCalibration message.
/**
...
/// Finalize srv/ImuCalibration message.
/**
...
/// Create srv/ImuCalibration message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * imu_interfaces__srv__ImuCalibration_Request__init().
...
/// Destroy srv/ImuCalibration message.
/**
 * It calls
 * imu_interfaces__srv__ImuCalibration_Request__fini()
...
/// Check for srv/ImuCalibration message equality.
/**
...
/// Copy a srv/ImuCalibration message.
/**
...
/// Initialize array of srv/ImuCalibration messages.
/**
...
/// Finalize array of srv/ImuCalibration messages.
/**
 * It calls
 * imu_interfaces__srv__ImuCalibration_Request__fini()
...
/// Create array of srv/ImuCalibration messages.
/**
 * It allocates the memory for the array and calls
 * imu_interfaces__srv__ImuCalibration_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/ImuCalibration messages.
/**
 * It calls
 * imu_interfaces__srv__ImuCalibration_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/ImuCalibration message array equality.
/**
...
/// Copy an array of srv/ImuCalibration messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * imu_interfaces__srv__ImuCalibration_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_imu_interfaces
...
/**
 * It calls
 * imu_interfaces__srv__ImuCalibration_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_imu_interfaces
...
/**
 * It allocates the memory for the array and calls
 * imu_interfaces__srv__ImuCalibration_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_imu_interfaces
...
/**
 * It calls
 * imu_interfaces__srv__ImuCalibration_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // IMU_INTERFACES__SRV__DETAIL__IMU_CALIBRATION__FUNCTIONS_H_
